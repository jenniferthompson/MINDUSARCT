...
vals_age <- quantile(
  model_df$age_consent, probs = c(0.10, 0.25, 0.50, 0.75, 0.90), na.rm = TRUE
)
...
treatment, so that each represents the expected median number of DCFDs for a
patient in each treatment group who is otherwise part of a "typical" *(many air quotes)* population.
