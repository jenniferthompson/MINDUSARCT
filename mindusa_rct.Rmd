...
label(inhosp_desc_df$tte_icudis_90_exp) <-
  "Days to first successful ICU discharge within 90 days"
...
Among patients with study drug temporarily held, the most common reasons were oversedation and "other." Study drug was most often permanently discontinued by
request of the patient, family, or medical team.

There is a somewhat higher proportion of patients in the ziprasidone group who
*ever* had study drug held, although the number of doses of study drug given
ended up being similar between groups. More patients in the placebo group had
drug held due to oversedation and "other" reasons. Compared to the placebo and
haloperidol groups, a slightly higher proportion of patients randomized to
ziprasidone ever had drug held due to prolonged QTc (~5%), and about 9% more
had drug held at some point due to medical team refusal.

Though one patient had study drug discontinued due to suspected NMS, there were
no *confirmed* cases after investigation by the DSMB.
...
rand_table <- left_join(rand_sums, rand_cont, by = "trt") %>%
  ...
  dplyr::select(
    ...
    npct_held, matches("^npct\\_held\\_"), npct_permdc,
  ...
  mutate(
    ...
    table_row = case_when(
      ...
      table_row == "npct_permdc_nms"         ~ "Suspected NMS",
...
rand_table %>%
  ...
  group_rows("Reasons Study Drug Temporarily Held", 17, 24) %>%
  group_rows("Reasons Study Drug Permanently Discontinued", 25, 32)
...
course of the study - generally two doses per day that the patient remained
alive and in the ICU. This includes doses where drug was held, temporarily or
permanently, for adverse clinical reasons; it does not include instances where
study drug was not administered due to resolution of delirium or patient
unavailability (including ICU discharge, death, study withdrawal, being off the floor, or being placed on comfort care measures/hospice).

*Study staff sometimes continued to document dose opportunities after permanent
discontinuation; therefore, describing permanent discontinuation by dose would be misleading, and it is omitted from this table. (For example, 24 doses in the placebo group were held due to coma due to structural brain damage, but these doses all came from three patients; similarly, the 22 doses discontinued for suspected NMS all came from one patient.)*
...
Oversedation was the most common reason for temporary hold by far, and was slightly more common in the placebo group, while slightly more doses in the
ziprasidone group were held due to prolonged QTc. Rates of medical team refusal
were similar between the three groups. Study drug hold due to other safety
concerns (adverse events, dystonia, EPS, NMS, DRESS) was very rare.
