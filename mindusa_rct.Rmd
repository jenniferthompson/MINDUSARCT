...
We collected data on the following elements related to the [ABCDEF Bundle](http://www.iculiberation.org/Bundles/Pages/default.aspx). In order to be
eligible for any of these on a given day, the patient had to have been in the
ICU all 24 hours.
...
- *Early mobility/exercise*
    ...
    - Compliant if: Was screened for safety, and either:
        ...
        - Met safety criteria, but did not receive mobility due to
...
get_comp_d <- function(df){
  ...
  df_d <- tribble(
    ...
    "Days Eligible",              days_elig,                       nrow(df),
    "Days Compliant",             days_comp,                       days_elig,
    "One",                        pluck(days_int_num, "1"),        days_comp,
    "Two",                        pluck(days_int_num, "2"),        days_comp,
    "Three",                      pluck(days_int_num, "3"),        days_comp,
    "Four",                       pluck(days_int_num, "4"),        days_comp,
