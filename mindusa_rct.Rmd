...
Our primary unadjusted analysis uses a Kaplan-Meier curve and log-rank test to look for differences between treatment groups in time to all-cause death.
...
```{r plot_unadj_death_30, fig.width = 7.5, fig.height = 6}
km_death_30$plot

```

```{r table_unadj_death_30, fig.width = 7.5, fig.height = 2}
km_death_30$table
