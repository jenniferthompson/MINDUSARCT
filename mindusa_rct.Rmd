...
label(ptsummary_all_df2$sofa_adm) <- "SOFA at consent"
label(ptsummary_all_df2$cv_sofa_adm_f) <- "Cardiovascular SOFA at consent"

html(summaryM(enroll_mv + enroll_nippv + enroll_shock + age_consent + gender +
                race_cat + ethnicity + english_level + education + insurance +
                bmi + home_antipsyc + charlson_total + frailty_f + icu_rsn +
                sofa_adm + cv_sofa_adm_f ~ randomized_f,
