...
```{r combine_tte}
## NOTE: This works with a previous version which used abbreviated treatment
## labels and combined KM curves with four other TTE outcomes. It no longer
## functions due to nrisk_death_90_pub and km_death_90_pub working differently,
## but is saved just in cases.
