...
main outcomes is modified by several factors. In secondary analyses `(NOTE: THIS IS STILL TO BE ADDED)`, we will include interaction (or cross-product) terms in
our multivariable models between treatment and the following variables:
