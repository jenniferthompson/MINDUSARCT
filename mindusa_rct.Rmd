...
We had three primary safety outcomes: neuroleptic malignant syndrome (NMS); Torsades de pointes (Torsades); and extrapyramidal symptoms (EPS). Incidence of each was minimal.

### NMS

During the entire hospitalization, `r ` patients ever experienced NMS, for a total of `r ` days. 
...
dcfd_plot <- ggplot(data = daily_int_df, aes(x = dcfd_int)) +
...
```{r dcfd_results, fig.width = 5, fig.height = 5}
