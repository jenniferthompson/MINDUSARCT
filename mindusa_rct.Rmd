...
missing_mental <- tribble(
  ...
  "Days with no non-missing assessment", n_days_ih_missrc, n_days_int_missrc
) %>%
  mutate(
    d_ih = c(
...
After any missing RASS and CAM values were imputed, we then determined all mental statuses (whether patients were comatose, delirious, hyperactively delirious, and hypoactively delirious) based on these imputed values.
