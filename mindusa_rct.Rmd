...
STILL IN PROGRESS YOU GUYS, AND TREATMENTS ARE ONCE AGAIN COMPLETELY FAKE
...
dcfd_ors <- map_df(
  ...
  mutate(
    ...
    outcome = case_when(
      outcome == "dcfd_int_nabad" ~ "Worst value",
      TRUE ~ "Best value"
    )
  ) %>%
...
ggplot(data = dcfd_ors, aes(y = effect, x = comp.c, colour = outcome)) +
  ...
  geom_point(shape = 15, colour = "black", size = 3,
...
#### TO DO MONDAY
## Flip factor order of best/worst
## Add p-values
