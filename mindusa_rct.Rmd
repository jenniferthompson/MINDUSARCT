...
[These figures] present the relationship between treatment and time-to-event outcomes at various levels of [age, IQCODE, sepsis, ICU type, SOFA]. Death and
hospital and ICU discharge are analyzed among all `r n_rand` randomized
patients. Liberation from mechanical ventilation is analyzed among the `r sum_na(ptsummary_df$on_mv_rand24)` randomized patients who received either type
of mechanical ventilation at or within 24 hours after randomization. ICU
readmission is analyzed only among the `r sum_na(ptsummary_df$elig_readm)` randomized patients who survived their initial ICU stay and were discharged to the floor.
