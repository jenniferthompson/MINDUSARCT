...
readmission), complete case analysis excludes `r pts_missany %>% pull(nmiss)` (`r rndformat(pts_missany %>% pull(pctmiss), 0)`%; `r glue_data(pts_missany_trt, "{trt}, {nmiss}") %>% paste(collapse = "; ")`).
